	 ...
	 <div class="fondoForm  light-blue accent-1">
                ...
                <div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input name="especialidad" class="form-control" type="text" placeholder="Unicamente para doctores" style="width:200px">
								</div>
                            ...
                            <div class="form-group row">
								...
								<div class="col-lg-9">
									<input name="pass" class="form-control" type="password" placeholder="" style="width:200px">
								</div>
